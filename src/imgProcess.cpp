...
Mat getDitherImgArray(const string& address,lv_img_header_t &Output,uint8_t * &data,ENCODE_MODE encode_mode)
{
...
//    Mat uu(Output.h,Output.w,CV_8UC1);
//    memcpy_s(uu.data,uu.total(),Output.data,Output.w*Output.h);
//    imshow("asf",uu);
//    resizeWindow("asf",300,300);
//    waitKey();
    return img;
}
